...
const subscribe = async () => {
  ...
  return (
    <footer className="text-gray-600 body-font bg-gray-200">
        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            <nav className="list-none flex flex-col mb-10 mx-2">
              <Link href="/">
                <a className="py-2 text-gray-600 hover:text-brink-pink-700">
                  Inicio
                </a>
              </Link>
              <Link href="/nosotros">
              ...
              <Link href="/contactanos">
                <a className="py-2 text-gray-600 hover:text-brink-pink-700">Contáctanos</a>
              </Link>
            </nav>
          </div>
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                ...
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-brink-pink-200 focus:border-brink-pink-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
              <button className={`lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-brink-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-brink-pink-600 rounded
      ...
      <div className="bg-brink-pink-600 h-20">
